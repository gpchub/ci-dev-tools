<div x-data="flatpickr"
    class="relative flatpickr flatpickr-input-wrapper"
    <?php echo $enableTime ? 'data-enable-time="1"' : ''; ?>
    x-ref="picker"
    x-model="<?= $model ?>"
    x-modelable="date"
>
    <input
        ...
        x-model="date"
    >
    <div class="form-input-icon cursor-pointer input-button" data-toggle>
